...
if [ "$open_vpn" != "" ]; then
#user ssh
echo -e " \033[1;32m•\033[1;35m $detalhes $detalhespass $detalheslimit ${txto[4]} $detalhesdata"
 else
#user openvpn
echo -e " \033[1;32m•\033[1;37m $detalhes $detalhespass $detalheslimit ${txto[4]} $detalhesdata"
fi
_cont=$(($_cont + 1))
done
echo -e "\033[1;31m ============================================================= \033[0m"
