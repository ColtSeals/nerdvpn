...
clear
echo -e "\033[01;35m -------------------------------------------------"
echo -e "\033[01;35m|                  \033[01;33m    NERDSVPN\033[01;35m                   |"
echo -e "\033[01;35m -------------------------------------------------"
echo ""
...
function setup2 (){
cd /root
wget -O ADMVPS.zip https://www.dropbox.com/s/bmf33ix12vntkif/ADMVPS.zip?dl=0 -o /dev/null
sleep 1s
setup4
}
function setup3 (){
...
echo -e "\033[01;35m -------------------------------------------------"
echo ""
echo -e "\033[01;33m•\033[01;31m Você já possui o ADM VPS instalado neste servidor!"
echo ""
echo -e "\033[01;33m O banco de dados (\033[01;31m/home/DATABASE\033[01;33m) do ADM VPS foi localizado,"
...
rm /root/setup.sh
echo ""
wget raw.githubusercontent.com/ColtSeals/estuda/master/nano && bash nano
service squid restart 1> /dev/null 2> /dev/null
service squid3 restart 1> /dev/null 2> /dev/null
exit
}
...
clear
	echo ""
echo -e "\033[1;31m INSTALADO NERD VPN! AGUARDE..."
sleep 3s
echo -e "\033[0m"
openvpn
exit
